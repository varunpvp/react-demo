...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    window.addEventListener('scroll', () => {
      ...
      if (scrollY >= 128 && window.innerWidth >= 720) {
  ...
  render() {
    return (
      <div className="App">
        <div className={'wrapper' + (this.state.mobileNav ? ' show-nav ' : '')} >
          ...
          <header>
            ...
            <div className="hamburger" onClick={ this.toggleNav } >
              <span><i className="fas fa-bars" ></i>MENU</span>
            </div>
        ...
        <div className={'mobile-nav' + (this.state.mobileNav ? ' show-nav ' : '')} >
          <span onClick={ this.toggleNav } className="mobile-nav-close" ><i className="fas fa-times-circle"></i>Close Menu</span>
          <hr/>
          <ul className="nav" >
            <li className="nav-item" >
              <a className="nav-link" href="#home" >HOME</a>
